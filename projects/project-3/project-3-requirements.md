...
#### Trello Board Planning - Links Due 11/2
...
### Project Presentations - Due 11/13
...
2.  **Identify roles** on the team, which may be:
    ...
    - **Scrum Master (required role)**: the leader of the Agile processes (user stories, stand-ups, etc.) and manager of Trello.
    ...
    - **Database manager (required role)**: this person will be in charge of creating and managing the models.
